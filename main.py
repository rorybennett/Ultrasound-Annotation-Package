...
class Main(QMainWindow):
    ...
    def _createMainMenu(self):
        ...
        menuExportYOLO3D = self.menuExport.addMenu('YOLO 3D')
        menuExportYOLO3D.addAction('Transverse', lambda: self.export.exportYOLO3DAUSData(Scan.PLANE_TRANSVERSE))
        menuExportYOLO3D.addAction('Sagittal', lambda: self.export.exportYOLOAUS3DData(Scan.PLANE_SAGITTAL))
